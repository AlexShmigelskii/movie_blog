...
class Movie(models.Model):
    ...
    fees_usa = models.PositiveIntegerField('Сборы в США', default=0, help_text='указать сумму в долларах')
    fees_world = models.PositiveIntegerField('Сборы в мире', default=0, help_text='указать сумму в долларах')
